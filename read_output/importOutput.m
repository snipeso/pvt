...
% filepath is the path + filename of the ".log" file you wish to import
% OutputType should be either "table" or "struct"
% extraFields is optional, and it's to add any extra information to the table
